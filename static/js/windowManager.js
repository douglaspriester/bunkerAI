...
export const OS_APPS = [
  ...
  { id: 'firstaid', name: 'Primeiros Socorros', icon: '\u{1FA7A}', width: 720, height: 600, viewId: 'firstaidView' },
...
const APP_CATEGORIES = [
  ...
  { id: 'survival', label: 'Sobrevivencia',     icon: '\u26A1',    apps: ['firstaid', 'pharmacy', 'shelter', 'supplies', 'map', 'radio', 'morse', 'phonetic', 'sun', 'waterCalc', 'weather', 'crypto', 'rations', 'plants', 'navigation'] },
